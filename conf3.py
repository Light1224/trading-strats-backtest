...
# Calculate combined score from signals and rolling sum
...
def main():
    ...
    for stock_file in stock_files:
        ...
        for strat_name, strat_func in strategies.items():
            ...
            print(f"  Strategy {strat_name}: {sig_df['Buy_Signal'].sum()} buy and {sig_df['Sell_Signal'].sum()} sell signals")
    ...
    print("\nSummary of Best Thresholds and Portfolio Performance saved to:", save_path)
